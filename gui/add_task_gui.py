...
class AddTaskSubFrame:
    ...
    def _build_form_panel(self):
        ...
        self.taskno_entry = CTkEntry(form,
                                     height=32,
                                     fg_color=C_TEAL_DIM,
                                     text_color=C_TEXT,
                                     border_color=C_TEAL_BRD)
        ...
        self.tasktype_dropdown = CTkOptionMenu(
            form,
            height=32,
            values=TYPE_OPTIONS,
            fg_color=C_VIOLET_DIM,
        ...
        self.priority_option = CTkSegmentedButton(
            form,
            values=["High", "Normal"],
            selected_color=C_TEAL_HOV,
            selected_hover_color=C_TEAL_HOV,
            unselected_color=C_TEAL_DIM,
            unselected_hover_color=C_TEAL_DIM,
        ...
        self.completed_switch = CTkSwitch(
            form,
        ...
        # --- Description
        CTkLabel(form, text="Description",
                 font=("DM Mono", 12),
                 text_color=C_TEXT2
                 ).grid(row=6, column=0, sticky="w")

        self.description_box = CTkTextbox(form,
                                          height=150,
                                          fg_color=C_VIOLET_DIM,
                                          border_color=C_VIOLET_BRD,
                                          border_width=2)
        self.description_box.grid(row=7, column=0, columnspan=2, sticky="nsew", pady=(4, 12))
